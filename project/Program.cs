...
namespace FirstPractic
{
    ...
    class Program
    {
        ...
        static async Task jsonFilesTask()
        {
            ...
            {
                Edward edward = new Edward() { Name = "Слава", Age = 31, Band = "ЯFURA", Style = "Программист" };
            ...
            string path = @"D:\test\programmist.json";
            deleteFile(path);
        }
